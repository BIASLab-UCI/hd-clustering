    ...
    def fit(self,
        ...
        for epoch in range(epochs):
            ...
            for i in range(0, n, batch_size):
                ...
                scores = self.scores(x_batch, encoded=True)
                ...
                if adaptive_update:
                    ...
                    x_batch = alpha*(x_batch.sign())

                # updates each clustering model
                for lbl in range(self.clusters):
                    x_batch_lbl = x_batch[preds == lbl]
                    self.model[lbl] += x_batch_lbl.sum(0)
